...
NAV = [
    ...
    },
    {
        ...
        "label": "Einstellungen",
        "icon": (
            "M10.3 3.5h3.4l.4 2.3 2 1.2 2.2-.9 1.7 3-1.8 1.5v2.3l1.8 1.5-1.7 3-2.2-.9-2 1.2"
            "-.4 2.3h-3.4l-.4-2.3-2-1.2-2.2.9-1.7-3L5.8 13v-2.3L4 9.2l1.7-3 2.2.9 2-1.2.4-2.4Z"
